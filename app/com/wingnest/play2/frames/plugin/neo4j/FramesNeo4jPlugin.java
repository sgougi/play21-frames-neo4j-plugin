...
public class FramesNeo4jPlugin extends PluginBase {

	public FramesNeo4jPlugin(final Application application) {
		super(application);
	}

	@Override
	protected <T extends FramedGraph<? extends Graph>> FramedGraphDirector<T> createFramedGraphDirector() {
		return (FramedGraphDirector<T>)new DefaultFramedGraphDirector(new Neo4jGraphManager());
	}
